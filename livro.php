...
if (!isset($_SESSION['usuario_id'])) {
    // Se não estiver logado, armazena uma mensagem na sessão
    $_SESSION['mensagem_login'] = "<div class='mensagem info'><p>Você precisa estar logado para visualizar os detalhes de um livro.</p></div>";
...
?>
    ...
    <script src="js/carrossel.js"></script> <?php include('includes/footer.php'); ?>