...
$res = $conn->query("SELECT * FROM livros ORDER BY titulo ASC");
?>
...
<div style="text-align: center; margin-bottom: 20px;">
    ...
    <a href="livros_lista.php" class="btn-secondary" style="padding: 8px 15px; background: #6c757d;">Voltar para a Lista</a>
</div>
